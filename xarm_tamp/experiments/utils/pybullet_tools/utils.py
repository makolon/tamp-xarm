...
# Gearbox
GREEN_GEAR_URDF = 'models/gearbox/gear1.urdf'
BLUE_GEAR_URDF = 'models/gearbox/gear2.urdf'
RED_GEAR_URDF = 'models/gearbox/gear3.urdf'
RED_SHAFT_URDF = 'models/gearbox/shaft1.urdf'
YELLOW_SHAFT_URDF = 'models/gearbox/shaft2.urdf'
GEARBOX_BASE_URDF = 'models/gearbox/gearbox_base.urdf'
...
def sample_reachable_base(robot, point, reachable_range=(0.4, 0.6)):
